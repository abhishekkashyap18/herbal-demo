        ...
        <div className="mx-auto bg-[#e5f4e6]">
            ...
            <div className='mt-5'>
                ...
                <li className='flex flex-row gap-44 justify-center pb-5 pt-2'>
                    <ul><img className='w-40 h-36 border-black rounded-full text-center font-extrabold' src="/category_1.jpg" alt="" /></ul>
                    <ul><img className='w-40 h-36 border-black rounded-full' src="/category_2.jpg" alt="" /></ul>
                    <ul><img className='w-40 h-36 border-black rounded-full' src="/category_3.jpg" alt="" /></ul>
                    <ul><img className='w-40 h-36 border-black rounded-full' src="/category_4.jpg" alt="" /></ul>
                </li>
            </div>
